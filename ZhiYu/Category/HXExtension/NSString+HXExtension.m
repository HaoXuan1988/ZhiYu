...
- (BOOL)isEmpty {
    ...
    if (self == nil || self.length == 0 || ![self isKindOfClass:[NSString class]]) {
        return YES;
    }else{
        return NO;
    }
...
+(BOOL)hx_isValidatMobilePhoneCode:(NSString *)phoneCode
{
    ...
    NSString *pattern = @"^((100)|(13[0-9])|(14[5|7])|(15[0-9])|(18[0-9])|(17[0-9]))\\d{8}$";
    
    NSPredicate *pred = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    BOOL isMatch = [pred evaluateWithObject:phoneCode];
    return isMatch;
}
